//
//  MapKitSwiftUIDemoView.swift
//  Demonstrates concepts from "Integrating MapKit with SwiftUI" (Hacking with Swift).
//
...
/// Wraps the map examples: styles, camera binding, markers, custom annotations, MapReader taps.
struct MapKitSwiftUIDemoView: View {
    ...
    @State private var mapStyleChoice: Int = 0
    @State private var interactionChoice: Int = 0
    ...
    /// Separate coordinate for the custom `Annotation` example (Hacking with Swift style).
