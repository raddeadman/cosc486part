...
//  Custom types, enums, and Codable — aligned with Apple's "Model data with custom types".
//
...
struct ModelTypesDemoView: View {
    ...
    @State private var jsonSnippet = "Tap “Encode JSON” to see `Codable` output."

    var body: some View {
        NavigationStack {
            List {
                Section("Courses (custom struct)") {
